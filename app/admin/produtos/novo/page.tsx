      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Adicione um novo produto ao catálogo</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-colors resize-none"
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-500 mt-1">Até 5 imagens - A primeira será a imagem principal</p>
            </div>
            <ImageUpload
              images={images}
              onChange={setImages}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-sm font-medium text-gray-600">R$</span>
                  <input
                    type="number"
                    step="0.01"
                    required
                    ...
                    className="w-full pl-11 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-colors"
                    placeholder="0,00"
                  />
                </div>
              </div>
          ...
          {/* Card: Estoque */}
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Estoque e SKU</h2>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 text-sm font-mono border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 transition-colors"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <select
              ...
              className="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 bg-white transition-colors"
            >
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500 mt-1">URL amigável</p>
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">
